...
class ClaseFamilias extends Modelo
{
    ...
    public static function read($idfamilia)
    {
        $sql = 'SELECT FAM.*'
            . ' FROM familias as FAM '
            . ' WHERE FAM.idFamilia =' . $idfamilia;
        $resultado = parent::_consulta($sql);
        return $resultado;
    }
    ...
    {
        return parent::_insert(self::$mitabla, $datos, $soloSQL);
    }

    public static function actualizar($idFamilia, $datos, $soloSQL = false)
    {
        return parent::_update(self::$mitabla, $datos, ['idFamilia='.$idFamilia], $soloSQL);
    }
